...
public class BankovyUcet{
    ...
    public void vypisZuctu(){
        ...
        System.out.println("Prehlad transakcii:");
        if (this.pohybyNaUcte.size() == 0)
            System.out.println("Na ucte nebola vykonana ziadna transakcia.");
        else{
            for(Transakcia t: pohybyNaUcte){
    ...
    public boolean setHeslo(String stareHeslo, String noveHeslo)
    {
        ...
        // 2. Nove heslo musi byt 4-miestne cislo (PIN kod)
    ...
    {
        if (this.PIN.equals(h))
            return true;
        else{
            System.out.println("Nespravny PIN kod!");
            return false;
        }
    }
}

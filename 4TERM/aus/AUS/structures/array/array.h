...
namespace structures 
{
	...
	{
		if (length) {
			Vector::copy(*src.vector_, mapFunction(srcStartIndex),
				*dest.vector_, mapFunction(destStartIndex), lenght * sizeof(T));
		}
	}
	...
	{
		DSRoutines::rangeCheckExcept(index, size_, "Invlaid index in Array!");
